...
async function main() {
	...
	const tags = await Promise.all([
		prisma.servicesTag.create({ data: { tenant: 'default', name: 'user' } }),
		prisma.servicesTag.create({ data: { tenant: 'default', name: 'auth' } }),
		prisma.servicesTag.create({ data: { tenant: 'default', name: 'admin' } }),
		prisma.servicesTag.create({ data: { tenant: 'default', name: 'payment' } }),
		prisma.servicesTag.create({ data: { tenant: 'default', name: 'transaction' } }),
		prisma.servicesTag.create({ data: { tenant: 'default', name: 'notification' } }),
		prisma.servicesTag.create({ data: { tenant: 'default', name: 'product' } }),
		prisma.servicesTag.create({ data: { tenant: 'default', name: 'catalog' } }),
		prisma.servicesTag.create({ data: { tenant: 'default', name: 'order' } }),
		prisma.servicesTag.create({ data: { tenant: 'default', name: 'analytics' } }),
	]);
	...
	const userCreateService = await prisma.servicesService.create({
		data: {
			...
			tags: {
				connect: [
					{ id: tags.find(t => t.name === 'user')!.id },
					{ id: tags.find(t => t.name === 'auth')!.id },
				],
			},
		},
	});
